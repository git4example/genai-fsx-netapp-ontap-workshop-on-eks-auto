...
To view the data boundary enforcement, in this module you will deploy **three AI Agents** using [AWS Strands Agents SDK](https://github.com/strands-agents/harness-sdk) (open source). Two of the AI Agent have distinct roles and related data access (Finance Agent & IT Operations Agent), and a third AI Agent will be used to simulate a Malicious AI Agent that will try to access data that it doesn't have access to, via different methods.
