...
The storage architecture uses the NetApp Astra Trident CSI driver to dynamically provision ONTAP-backed volumes. A Kubernetes Job loads the model data onto the persistent volume before the vLLM inference pod starts, replacing the transparent S3 import approach previously used with FSx for Lustre.

![lab-image-2](/static/images/lab-image-2.png)
